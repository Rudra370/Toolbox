class Youtube {
	...
	Youtube({this.id, this.cipher, this.meta, this.thumb, this.itags, this.videoQuality, this.url, this.hosting, this.srv, this.sd, this.hd});
	...
	Youtube.fromJson(Map<String, dynamic> json) {
		...
		if (json['url'] != null) {
			url = new List<Url>();
			json['url'].forEach((v) { url.add(new Url.fromJson(v)); });
		}
...
class Url {
	...
	Url({this.url, this.name, this.subname, this.infoUrl, this.type, this.ext, this.downloadable, this.quality, this.audio, this.noAudio, this.itag, this.filesize, this.attr, this.infoToken});
